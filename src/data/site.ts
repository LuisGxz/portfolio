  ...
  projects: [
    {
      ...
      category: "Mobile", live: "#", source: "#", placeholder: "MOBILE / IONIC",
    },
    {
      id: 2, title: "Tenant Console",
      blurb: {
      ...
      category: "Full-Stack", live: "#", source: "#", placeholder: "DASHBOARD / SAAS",
    },
    {
      id: 3, title: "Event Ledger",
      blurb: {
      ...
      category: "Backend", live: "#", source: "#", placeholder: "BACKEND / EVENTS",
    },
    {
      id: 4, title: "Pulse Dashboard",
      blurb: {
      ...
      category: "Full-Stack", live: "#", source: "#", placeholder: "DASHBOARD / METRICS",
    },
    {
      id: 5, title: "Onboarding Wizard",
      blurb: {
      ...
      category: "Frontend", live: "#", source: "#", placeholder: "WEB / ONBOARDING",
    },
    {
      id: 6, title: "Doc Sign API",
      blurb: {
      ...
      category: "Backend", live: "#", source: "#", placeholder: "API / SIGNING",
    },
    {
      id: 7, title: "Field Inventory",
      blurb: {
      ...
      category: "Mobile", live: "#", source: "#", placeholder: "MOBILE / RETAIL",
    },
    {
      id: 8, title: "Marketing Site",
      blurb: {
      ...
      tags: ["React", "TypeScript"],
      category: "Frontend", live: "#", source: "#", placeholder: "WEB / MARKETING",
    },
  ],
};
...
export const TRANSLATIONS = {
  en: {
    ...
    projects: {
      filterAll: "All",
      filters: { Frontend: "Frontend", Backend: "Backend", "Full-Stack": "Full-Stack", Mobile: "Mobile" } as Record<string, string>,
  ...
  es: {
    ...
    projects: {
      filterAll: "Todos",
      filters: { Frontend: "Frontend", Backend: "Backend", "Full-Stack": "Full-Stack", Mobile: "Móvil" } as Record<string, string>,
...
export const TECH_GLYPHS: Record<string, string> = {
  Angular: "A", Ionic: "I", React: "R", TypeScript: "TS",
  ".NET": ".N", "Node.js": "N", Python: "Py", Java: "J",
  "SQL Server": "SQ", MySQL: "My", MongoDB: "M", PostgreSQL: "Pg",
  Azure: "Az", "Azure DevOps": "AD", "GitHub Actions": "GA", Docker: "Dk",
};

export const PROFICIENCY: Record<string, number> = {
  Angular: 95, React: 85, Ionic: 90, TypeScript: 90,
  ".NET": 85, "Node.js": 80, Python: 70, Java: 65,
  "SQL Server": 85, MySQL: 75, MongoDB: 80, PostgreSQL: 75,
  Azure: 80, "Azure DevOps": 75, "GitHub Actions": 70, Docker: 70,
};
